...
class LivePlot(QMainWindow):
    def __init__(self):
        ...
        self.size = self.plc.read_by_name('MAIN.Size1', pyads.PLCTYPE_INT)

        # Gerar os dados para o gráfico
        self.x = [-1*i for i in range(1,self.size+1,1)]  # Eixo X fixo (tempo)
    ...
    def update_plot(self):
        ...
        value = list(self.plc.read_by_name('MAIN.Buffer1_y', pyads.PLCTYPE_REAL * self.size))
